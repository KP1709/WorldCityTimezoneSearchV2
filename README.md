...
## ⌨️ Tech stack
React / Typescript / pnpm / Luxon / Shadcn / Tailwind CSS / Mapcn / Zustand
...
## 🛠️ Features
- Search for world cities through the local GeoNames CSV file
...
- Originally connected a supabase database where cities would be queried from. For the long term, decided to remove this and use the CSV file given data won't change often. This is imported as a url so it's loaded at runtime. 
